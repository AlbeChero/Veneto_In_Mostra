...
--
-- Host: 127.0.0.1
-- Creato il: Ago 31, 2018 alle 10:56
...
('arte', 'Palazzo Chiericati &egrave; un edificio rinascimentale sito a Vicenza in piazza Matteotti, a fianco della parte terminale di corso Palladio. Progettato nel 1550 come residenza nobiliare per i conti Chiericati dall\'architetto Andrea Palladio e costruito a partire dal 1551, fu completato solo alla fine del Seicento. Sede storica del museo civico (dal 1855), ospita il museo civico, che comprende collezioni di dipinti, stampe, disegni, numismatica, statuaria medievale e moderna. Il palazzo &egrave; inserito dal 1994 nella lista dei Patrimoni dell\'umanit&agrave; dell\'UNESCO assieme alle altre architetture palladiane della citt&agrave;.', 'Palazzo Chiericati', '../IMG/vicenza/arte/chiericati.jpg', NULL, NULL, NULL, NULL, 'Immagine di palazzo chiericati', 19);
